...
/// Represents a camera resolution with width, height, and FPS range.
class PlatformCameraResolution {
  PlatformCameraResolution({
    required this.width,
...
class PlatformMediaSettings {
  ...
  final PlatformCameraResolution resolution;
  final int? fps;
...
abstract class CameraApi {
  ...
  /// Returns the list of available resolutions for a specific camera.
  List<PlatformCameraResolution> getAvailableResolutions(String cameraName);

  /// Get available video resolutions for the specified camera.
  /// Returns resolutions supported by CamcorderProfile for video recording.
  @async
  List<PlatformCameraResolution> getAvailableVideoResolutions(String cameraName);
