...
public class Messages {
   ...
   * Generated class from Pigeon that represents data sent in messages.
   */
  public static final class PlatformCameraResolution {
    ...
    private @NonNull Long minFps;

    public @NonNull Long getMinFps() {
      return minFps;
    }

    public void setMinFps(@NonNull Long setterArg) {
      if (setterArg == null) {
        throw new IllegalStateException("Nonnull field \"minFps\" is null.");
      }
      this.minFps = setterArg;
    }

    private @NonNull Long maxFps;

    public @NonNull Long getMaxFps() {
      return maxFps;
    }

    public void setMaxFps(@NonNull Long setterArg) {
      if (setterArg == null) {
        throw new IllegalStateException("Nonnull field \"maxFps\" is null.");
      }
      this.maxFps = setterArg;
    }
    ...
    public boolean equals(Object o) {
      if (this == o) { return true; }
      if (o == null || getClass() != o.getClass()) { return false; }
      PlatformCameraResolution that = (PlatformCameraResolution) o;
      return width.equals(that.width) && height.equals(that.height) && minFps.equals(that.minFps) && maxFps.equals(that.maxFps);
    }

    @Override
    public int hashCode() {
      return Objects.hash(width, height, minFps, maxFps);
    }
    ...
    public static final class Builder {
      ...
      private @Nullable Long minFps;

      @CanIgnoreReturnValue
      public @NonNull Builder setMinFps(@NonNull Long setterArg) {
        this.minFps = setterArg;
        return this;
      }

      private @Nullable Long maxFps;

      @CanIgnoreReturnValue
      public @NonNull Builder setMaxFps(@NonNull Long setterArg) {
        this.maxFps = setterArg;
        return this;
      }

      public @NonNull PlatformCameraResolution build() {
        PlatformCameraResolution pigeonReturn = new PlatformCameraResolution();
        pigeonReturn.setWidth(width);
        pigeonReturn.setHeight(height);
        pigeonReturn.setMinFps(minFps);
        pigeonReturn.setMaxFps(maxFps);
        return pigeonReturn;
      }
    }
    ...
    ArrayList<Object> toList() {
      ...
      toListResult.add(width);
      toListResult.add(height);
      toListResult.add(minFps);
      toListResult.add(maxFps);
      return toListResult;
    }

    static @NonNull PlatformCameraResolution fromList(@NonNull ArrayList<Object> pigeonVar_list) {
      PlatformCameraResolution pigeonResult = new PlatformCameraResolution();
      Object width = pigeonVar_list.get(0);
      pigeonResult.setWidth((Long) width);
      Object height = pigeonVar_list.get(1);
      pigeonResult.setHeight((Long) height);
      Object minFps = pigeonVar_list.get(2);
      pigeonResult.setMinFps((Long) minFps);
      Object maxFps = pigeonVar_list.get(3);
      pigeonResult.setMaxFps((Long) maxFps);
      return pigeonResult;
    }
  }
  ...
  public static final class PlatformMediaSettings {
    private @NonNull PlatformCameraResolution resolution;

    public @NonNull PlatformCameraResolution getResolution() {
      return resolution;
    }

    public void setResolution(@NonNull PlatformCameraResolution setterArg) {
      if (setterArg == null) {
        throw new IllegalStateException("Nonnull field \"resolution\" is null.");
      }
      this.resolution = setterArg;
    }
    ...
    public boolean equals(Object o) {
      ...
      return resolution.equals(that.resolution) && Objects.equals(fps, that.fps) && Objects.equals(videoBitrate, that.videoBitrate) && Objects.equals(audioBitrate, that.audioBitrate) && enableAudio.equals(that.enableAudio);
    }

    @Override
    public int hashCode() {
      return Objects.hash(resolution, fps, videoBitrate, audioBitrate, enableAudio);
    }

    public static final class Builder {

      private @Nullable PlatformCameraResolution resolution;

      @CanIgnoreReturnValue
      public @NonNull Builder setResolution(@NonNull PlatformCameraResolution setterArg) {
        this.resolution = setterArg;
        return this;
      }
      ...
      public @NonNull PlatformMediaSettings build() {
        ...
        pigeonReturn.setResolution(resolution);
    ...
    static @NonNull PlatformMediaSettings fromList(@NonNull ArrayList<Object> pigeonVar_list) {
      ...
      Object resolution = pigeonVar_list.get(0);
      pigeonResult.setResolution((PlatformCameraResolution) resolution);
  ...
  private static class PigeonCodec extends StandardMessageCodec {
    ...
    protected Object readValueOfType(byte type, @NonNull ByteBuffer buffer) {
      switch (type) {
        ...
        case (byte) 139:
          return PlatformCameraResolution.fromList((ArrayList<Object>) readValue(buffer));
        case (byte) 140:
    ...
    protected void writeValue(@NonNull ByteArrayOutputStream stream, Object value) {
      ...
      } else if (value instanceof PlatformCameraResolution) {
        stream.write(139);
        writeValue(stream, ((PlatformCameraResolution) value).toList());
  ...
  public interface CameraApi {
    ...
    @NonNull 
    List<PlatformCameraResolution> getAvailableResolutions(@NonNull String cameraName);
    /**
     ...
     */
    void getAvailableVideoResolutions(@NonNull String cameraName, @NonNull Result<List<PlatformCameraResolution>> result);
    ...
    static void setUp(@NonNull BinaryMessenger binaryMessenger, @NonNull String messageChannelSuffix, @Nullable CameraApi api) {
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.camera_android.CameraApi.getAvailableResolutions" + messageChannelSuffix, getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<>();
                ...
                try {
                  List<PlatformCameraResolution> output = api.getAvailableResolutions(cameraNameArg);
                  wrapped.add(0, output);
                }
 catch (Throwable exception) {
                  wrapped = wrapError(exception);
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.camera_android.CameraApi.getAvailableVideoResolutions" + messageChannelSuffix, getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<>();
                ArrayList<Object> args = (ArrayList<Object>) message;
                String cameraNameArg = (String) args.get(0);
                Result<List<PlatformCameraResolution>> resultCallback =
                    new Result<List<PlatformCameraResolution>>() {
                      public void success(List<PlatformCameraResolution> result) {
                ...
                api.getAvailableVideoResolutions(cameraNameArg, resultCallback);
              });
        } else {
          channel.setMessageHandler(null);
        }
