...
class Camera
  ...
  public static class VideoCaptureSettings {
    @NonNull public final Size resolution;
    ...
    public VideoCaptureSettings(@NonNull Size resolution, boolean enableAudio) {
      this(resolution, enableAudio, null, null, null);
    }
  }
  ...
  public Camera(
    ...
    this.cameraFeatures =
        CameraFeatures.init(
            ...
            activity,
            dartMessenger,
            videoCaptureSettings.resolution);
