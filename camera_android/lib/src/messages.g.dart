...
class PlatformCameraResolution {
  ...
  static PlatformCameraResolution decode(Object result) {
    result as List<Object?>;
    return PlatformCameraResolution(
      width: result[0]! as int,
      height: result[1]! as int,
      minFps: result[2]! as int,
...
class PlatformMediaSettings {
  ...
  static PlatformMediaSettings decode(Object result) {
    ...
    return PlatformMediaSettings(
      resolution: result[0]! as PlatformCameraResolution,
      fps: result[1] as int?,
...
class _PigeonCodec extends StandardMessageCodec {
  ...
  void writeValue(WriteBuffer buffer, Object? value) {
    if (value is int) {
      ...
      buffer.putUint8(138);
      writeValue(buffer, value.encode());
    }    else if (value is PlatformCameraResolution) {
      buffer.putUint8(139);
      writeValue(buffer, value.encode());
  ...
  Object? readValueOfType(int type, ReadBuffer buffer) {
    switch (type) {
      ...
      case 139: 
        return PlatformCameraResolution.decode(readValue(buffer)!);
      case 140: 
...
class CameraApi {
  ...
  Future<List<PlatformCameraResolution>> getAvailableResolutions(String cameraName) async {
    final String pigeonVar_channelName = 'dev.flutter.pigeon.camera_android.CameraApi.getAvailableResolutions$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
    ...
    if (pigeonVar_replyList == null) {
      ...
      return (pigeonVar_replyList[0] as List<Object?>?)!.cast<PlatformCameraResolution>();
    }
  }
  ...
  Future<List<PlatformCameraResolution>> getAvailableVideoResolutions(String cameraName) async {
    final String pigeonVar_channelName = 'dev.flutter.pigeon.camera_android.CameraApi.getAvailableVideoResolutions$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
