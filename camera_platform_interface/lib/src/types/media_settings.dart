...
class MediaSettings {
  ...
  /// The camera resolution for video recording and image capture.
  /// If provided, this takes precedence over [resolutionPreset].
  final CameraResolution? resolution;

  /// [ResolutionPreset] affect the quality of video recording and image capture.
  /// Deprecated: Use [resolution] instead for more precise control.
