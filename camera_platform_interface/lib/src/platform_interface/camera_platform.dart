...
abstract class CameraPlatform extends PlatformInterface {
  ...
  /// Returns available resolutions for the specified camera.
  ///
  /// [cameraId] is the camera identifier (index in availableCameras list).
  /// Returns a list of [CameraResolution] objects representing all
  /// resolutions supported by the camera for photo/video capture.
  Future<List<CameraResolution>> getAvailableResolutions(int cameraId) {
    throw UnimplementedError('getAvailableResolutions() is not implemented.');
  }

  /// Get available video resolutions for the camera with [cameraId].
  /// Returns resolutions supported by CamcorderProfile for video recording.
  Future<List<CameraResolution>> getAvailableVideoResolutions(int cameraId) {
    throw UnimplementedError('getAvailableVideoResolutions() is not implemented.');
  }
